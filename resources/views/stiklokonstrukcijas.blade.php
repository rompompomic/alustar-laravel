        ...
        <section class="w-full py-16 md:py-24 bg-background">
            <div class="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-16">
                ...
                <div class="mt-12 rounded-2xl overflow-hidden shadow-lg h-[300px] md:h-[400px]">
                    <img src="{{ asset('assets/asset5.webp') }}" alt="Stikla konstrukciju piemēri" class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
                </div>
            </div>
        </section>
        ...
        <section class="w-full py-16 md:py-24 bg-background">
            <div class="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-16">
                 <div class="flex flex-col items-center text-center mb-12">
                    ...
                    <p class="mt-4 text-muted-foreground max-w-2xl mx-auto">Mēs izmantojam tikai sertificētus un pārbaudītus materiālus no vadošajiem Eiropas ražotājiem.</p>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                     <div class="rounded-2xl overflow-hidden shadow-lg h-[300px] lg:h-[400px]">
                        <img src="{{ asset('assets/asset6.webp') }}" alt="Materiāli un tehnoloģijas" class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
                    </div>
                    <div>

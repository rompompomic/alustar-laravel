        ...
        <section class="relative w-full h-[50svh] min-h-[410px] max-h-[510px] overflow-hidden" style="clip-path: polygon(0 0, 100% 0, 100% 81%, 0 100%)">
            ...
            <div class="relative h-full flex flex-col justify-end px-4 sm:px-6 pb-24 sm:pb-28">
                <div class="flex flex-col items-start gap-3 w-full animate-fade-up">
                    ...
                    <p class="font-medium text-primary-foreground/90 text-sm sm:text-base tracking-[0.72px]">Fasādes, logi, durvis, starpsienas</p>
                    <a href="{{ url('/stiklokonstrukcijas') }}" class="flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg bg-brand-green hover:opacity-90 hover:shadow-lg transition-all duration-200">
                        <span class="font-medium text-primary-foreground text-sm tracking-[-0.48px] whitespace-nowrap">Uzzināt vairāk</span>
        ...
        <section class="relative w-full h-[50svh] min-h-[380px] max-h-[480px] md:h-[50svh] md:min-h-[380px] md:max-h-[460px] overflow-hidden -mt-[14svh] md:-mt-[12svh]" style="clip-path: polygon(0 15%, 100% 0, 100% 100%, 0 100%)">
            ...
            <div class="relative h-full flex flex-col justify-end px-4 sm:px-6 pb-12 sm:pb-14">
                <div class="flex flex-col items-start gap-3 w-full animate-fade-up">
                    ...
                    <p class="font-medium text-secondary-foreground/90 text-sm sm:text-base tracking-[0.72px]">Pilna cikla būvniecības pakalpojumi</p>
                    <a href="{{ url('/buvnieciba') }}" class="flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg bg-brand-gray hover:opacity-90 hover:shadow-lg transition-all duration-200">
                        <span class="font-medium text-secondary-foreground text-sm tracking-[-0.48px] whitespace-nowrap">Uzzināt vairāk</span>
        ...
        <section class="absolute left-0 top-0 w-[54%] h-full bg-muted bg-cover bg-no-repeat bg-center z-10 contrast-[1.1] saturate-[0.95]" style="background-image: url('{{ asset('assets/hero-glass.webp') }}'); clip-path: polygon(0 0, 100% 0, 85% 100%, 0 100%)">
            ...
            <div class="relative flex flex-col items-start gap-11 mt-[420px] ml-[100px] w-[336px]">
                <div class="flex flex-col items-start gap-3.5 w-full animate-fade-up">
                    ...
                    <p class="font-medium text-primary-foreground/90 text-lg tracking-[0.72px]">Fasādes, logi, durvis, starpsienas</p>
                </div>
                <a href="{{ url('/stiklokonstrukcijas') }}" class="flex items-center justify-between w-[194px] px-5 py-3 rounded-lg bg-brand-green hover:opacity-90 hover:shadow-lg transition-all duration-200 animate-fade-up" style="animation-delay: 0.2s">
                    <span class="font-medium text-primary-foreground text-base tracking-[-0.48px] whitespace-nowrap">Uzzināt vairāk</span>
                    <i data-lucide="arrow-right" class="w-3.5 h-3.5 text-primary-foreground"></i>
                </a>
            </div>
        </section>
        ...
        <section class="absolute right-0 top-0 w-[55%] h-full bg-cover bg-center contrast-[1.05] saturate-[0.9]" style="background-image: url('{{ asset('assets/hero-construction.webp') }}'); clip-path: polygon(15% 0, 100% 0, 100% 100%, 0 100%)">
            ...
            <div class="relative flex flex-col items-start gap-11 mt-[450px] ml-[260px] w-[336px]">
                <div class="flex flex-col items-start gap-3.5 w-full animate-fade-up">
                    ...
                    <p class="font-medium text-secondary-foreground/90 text-lg tracking-[0.72px]">Pilna cikla būvniecības pakalpojumi</p>
                </div>
                <a href="{{ url('/buvnieciba') }}" class="flex items-center justify-between w-[194px] px-5 py-3 rounded-lg bg-brand-gray hover:opacity-90 hover:shadow-lg transition-all duration-200 animate-fade-up" style="animation-delay: 0.2s">
                    <span class="font-medium text-secondary-foreground text-base tracking-[-0.48px] whitespace-nowrap">Uzzināt vairāk</span>
                    <i data-lucide="arrow-right" class="w-3.5 h-3.5 text-secondary-foreground"></i>
                </a>
            </div>
        </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div class="flex flex-col items-center justify-center p-6 bg-background rounded-xl border border-border/50 transition-all duration-300 hover:shadow-lg hover:border-primary/30 min-h-[120px] text-center">
                    ...
                    <span class="text-sm text-muted-foreground">Eiropas standarti</span>
                </div>
                <div class="flex flex-col items-center justify-center p-6 bg-background rounded-xl border border-border/50 transition-all duration-300 hover:shadow-lg hover:border-primary/30 min-h-[120px] text-center">
...
<section class="w-full py-16 md:py-24 bg-[#e8e8ee]">
    <div class="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-16">
        <div class="text-center mb-12 md:mb-16">
            ...
            <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-foreground tracking-tight">Uzticamība pierādīta praksē</h2>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-16">
            ...
            <div class="group p-6 md:p-8 bg-muted/50 rounded-2xl text-center transition-all duration-300 hover:bg-primary hover:shadow-lg">
                ...
                <div class="text-sm text-muted-foreground group-hover:text-primary-foreground/80 transition-colors duration-300 uppercase tracking-wide">projekti</div>
            </div>
            <div class="group p-6 md:p-8 bg-muted/50 rounded-2xl text-center transition-all duration-300 hover:bg-primary hover:shadow-lg">
                ...
                <div class="text-sm text-muted-foreground group-hover:text-primary-foreground/80 transition-colors duration-300 uppercase tracking-wide">m² būvju</div>
            </div>
            <div class="group p-6 md:p-8 bg-muted/50 rounded-2xl text-center transition-all duration-300 hover:bg-primary hover:shadow-lg">
                ...
                <div class="text-sm text-muted-foreground group-hover:text-primary-foreground/80 transition-colors duration-300 uppercase tracking-wide">standarti</div>
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div class="p-6 md:p-8 bg-muted/30 rounded-2xl border border-border/50 transition-all duration-300 hover:border-primary/30 hover:shadow-md">
                ...
                <h4 class="text-lg font-semibold text-foreground mb-3">Inženiertehniskā atbildība</h4>
                <p class="text-sm text-muted-foreground leading-relaxed">Atbildība par konstrukciju aprēķiniem, materiālu izvēli un montāžas kvalitāti.</p>
            </div>
            <div class="p-6 md:p-8 bg-muted/30 rounded-2xl border border-border/50 transition-all duration-300 hover:border-primary/30 hover:shadow-md">
                <div class="w-10 h-1 bg-primary rounded-full mb-6"></div>
                <h4 class="text-lg font-semibold text-foreground mb-3">Juridiskā atbildība</h4>
                <p class="text-sm text-muted-foreground leading-relaxed">Līgumiska atbildība par saistību izpildi, termiņu ievērošanu un garantijas nodrošināšanu.</p>
            </div>
            <div class="p-6 md:p-8 bg-muted/30 rounded-2xl border border-border/50 transition-all duration-300 hover:border-primary/30 hover:shadow-md">
                <div class="w-10 h-1 bg-primary rounded-full mb-6"></div>
                <h4 class="text-lg font-semibold text-foreground mb-3">Dokumentācija un atbilstība</h4>
                <p class="text-sm text-muted-foreground leading-relaxed">Visi objekti tiek nodoti ar pilnu tehnisko un atbilstības dokumentāciju.</p>
            </div>
        </div>
    </div>
</section>
